...
class TextTask(Task):
    ...
    def test_output(self, idx: int, output: str):
        ...
        if self.evaluator_model is not None:
            score_kwargs['model'] = self.evaluator_model
        if self.evaluator_temperature is not None:
            score_kwargs['temperature'] = self.evaluator_temperature
        score_outputs = gpt(prompt, **score_kwargs)
        scores = []
